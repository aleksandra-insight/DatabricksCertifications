...
-- MAGIC
-- MAGIC - and this is a bullet point
-- MAGIC
-- MAGIC My GitHub account: https://github.com/aleksandra-insight
-- MAGIC or like this - <a href="https://github.com/aleksandra-insight" target="_blank">my GitHub account</a>
-- MAGIC
